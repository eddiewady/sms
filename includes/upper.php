...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Dec 2019 04:53:54 GMT -->
    ...
    <div id="wrapper" class="wrapper bg-ash">
       <!-- Header Menu Area Start Here -->
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            ...
            <div class="header-main-menu collapse navbar-collapse" id="mobile-navbar">
                ...
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="../admin.php" role="button" data-toggle="dropdown"
                            aria-expanded="false">
            ...
            <h6 class="item-title"><?php echo $_SESSION['username'];?></h6>
                            </div>
                            <div class="item-content">
                                ...
                                <li><a href="index.php?logout='1'"><i class="flaticon-turn-off"></i>Log Out</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    <li class="navbar-item dropdown header-message">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="item-header">
                                <h6 class="item-title">15 Message</h6>
                            </div>
                            <div class="item-content">
                                <div class="media">
